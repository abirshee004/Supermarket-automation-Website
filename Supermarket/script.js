...
document.querySelector('button').addEventListener('click', function() {
    const query = document.querySelector('#search-bar').value.trim(); // get value from search input
...
// This part for 'Enter' key press handling can be kept as-is or removed since the click event is already handled
